...
const dummyData = [
  {
    ...
    button : <Button  sx={{backgroundColor :"#3d69fa",color :"white",borderRadius:"20px"}}>Active</Button>,
    salary : "$10,000.00",
  },
  {
    name: "Aiden Lloyd",
  ...
  },
  {
    ...
    subName: "task description 1",
    kpi: <LinearProgress variant="determinate" value={30} color="primary" />,
    button : <Button  sx={{backgroundColor :"#3d69fa",color :"white",borderRadius:"20px"}}>Non Active</Button>,
    salary : "$10,000.00",
  },
  {
    name: "Aaren Rose",
...
const TableData = ({ themeColor = "e35981" }) => {
  const columnConfigs = [
    {
      id: "name",
      label: "Name",
